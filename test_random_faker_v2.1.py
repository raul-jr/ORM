...
def generate_hl7_message(msg_id, orc_5, placer_order_number=None, filler_order_number=None):
    ...
    # If placer_order_number and filler_order_number are not provided, generate new ones
    ...
    orc.orc_5 = orc_5  # Order control code
    ...
    return msg.to_er7(), placer_order_number, filler_order_number
...
# Generate and send HL7 messages for each patient
num_patients = 5  # Number of patients
for i in range(1, num_patients + 1):
    # First send message with "IP" control code
    hl7_message_ip, placer_order_number, filler_order_number = generate_hl7_message(i, "IP")
    send_hl7_message(hl7_message_ip, ports=[2575, 2576])
    
    # Then send the same message with "OC" control code
    hl7_message_oc, _, _ = generate_hl7_message(i, "OC", placer_order_number, filler_order_number)
