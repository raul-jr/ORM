...
for i in range(1, 5):
    base_msg = generate_base_hl7_message(i)  # Generate base message without order segments

    for order_control_code in ["SC", "IP", "OC", "HD"]:
        msg = Message.from_str(base_msg.to_er7())  # Create a new message from the ER7 string of the base message
