...
# Generate and send HL7 messages from 1 to 9 with cycling order control codes for the same patient
for i, order_control_code in zip(range(1, 10), order_control_codes):
